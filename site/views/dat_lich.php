<div class="divdl" style="width: 685px;">
            ...
            <?php if (isset($_SESSION["id"])) {
                      ...
                      <form action="?ctrl=home&act=datlichxem"  method="post" name="myfor"  onsubmit="return validatefor()">
                              ...
                              <input class="ipdl4" id="ten_nguoi_dat" name="ten_nguoi_dat" type="text" placeholder="Họ tên" value="<?=$kh['ho_ten'] ?>" style="width: 90%">
                              <input class="ipdl4" id="sodt" name="sodt" placeholder="Số điện thoại" value="<?=$kh['sdt'] ?>" style="width: 90%">
