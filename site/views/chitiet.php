                ...
                <div class="tuvan ">
                    ...
                    ?>
                        <form action="?ctrl=home&act=datlichxem" method="post" class="form-tuvan" name="myform" onsubmit="return validateform()">
                            <div class="fiel">
                                <input type="hidden" name="ma_can" value="<?= $row['ma_can'] ?>" id="" style="font-size: 10pt;">
                            </div>
                            <input type="hidden" name="trang_thai_lich" value="1">
                            <div class="fiel">
                                <input type="hidden" name="ma_tk" value="<?= $_SESSION['id'] ?>" id="" style="font-size: 10pt;">
                            </div>
                            <div class="fiel">
                            ...
                            <div class="fiel" style="margin-top: 0px;font-size: 10pt;">
                                ...
                                <input type="date" min="<?= date("Y-m-d") ?>" name="ngay_xem" id="" style="font-size: 10pt;width: 50%;float: left;">
                                 <input class="ipdl4" id="gio_xem" name="gio_xem" type="time" placeholder="Chọn giờ" style="font-size: 10pt; width: 50%;float: left;" >
                            ...
                            <div class="fiel">
                                <form action="?ctrl=home&act=datlichxem" method="post" class="form-tuvan" name="myform" onsubmit="return validateform()">
                                    ...
                                    <div class="fiel" style="margin-top: 50px;" style="font-size: 10pt;">
                                        ...
                                        <br>
                                        <br>
                                        <input class="ipdl4" id="sodt" type="text" name="sodt" placeholder="<?=$kh['sdt'] ?>" value="<?=$kh['sdt'] ?>" style ="width: 50%;">
                                        <br>
                                        <br>
